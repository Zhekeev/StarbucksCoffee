...
public class Americano implements TellAboutTheComposition {
   ...
   public void AmericanoCoffee(){
    ...
    public void tellAboutTheCompositionCoffee() {
            ...
            System.out.println("Интересный факт: фильтр-кофе vs американо! Все началось с американских солдат и их любви к черному фильтр кофе.");
            System.out.println("Напиток, который готовят в Эспрессо-машине, получил название “Американо”, во время 2-й Мировой войны при оккупации  Италии войсками США.)");
            System.out.println("Американские солдаты, скучавшие по родине и черному кофе, заказывали в Итальянских кафе,");
            System.out.println("непривычно крепкий для них “Эспрессо” и разбавляли его горячей водой, что бы напиток стал похож на фильтр-кофе.");
            System.out.println("Тогда то, Итальянские бариста и прозвали его “Американо” (что значит: Американский), и записали рецепт: “божественный Эспрессо разбавить кипятком до неузнаваемости");
            System.out.println("");
    }
